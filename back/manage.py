...
rooms_data = [
    (1, 'Гобеленовая гостиная', 
        ...
        '''
    , '/static/audio-room1.mp3', '/static/room1.png'),
    (2, 'Спальня княгини', 
        '''
            Князья Юсуповы славились европейским уровнем культуры и неограниченным
            финансовыми возможностями, позволявшими не только следовать последней моде,
            ...
            в Эрмитаж, а их место заняли копии.
        '''
    , '/static/audio-room1.mp3', '/static/room2.png'),
    (3, 'Большая ротонда', 
        '''
            Князья Юсуповы славились европейским уровнем культуры и неограниченным
            финансовыми возможностями, позволявшими не только следовать последней моде,
            ...
            в Эрмитаж, а их место заняли копии.
        '''
    , '/static/audio-room1.mp3', '/static/room3.png'),
    (4, 'Синяя гостиная', 
        '''
            Князья Юсуповы славились европейским уровнем культуры и неограниченным
            финансовыми возможностями, позволявшими не только следовать последней моде,
            ...
            в Эрмитаж, а их место заняли копии.
        '''
    , '/static/audio-room1.mp3', '/static/room4.png'),
    (5, 'Красная гостиная', 
        '''
            Князья Юсуповы славились европейским уровнем культуры и неограниченным
            финансовыми возможностями, позволявшими не только следовать последней моде,
            ...
            в Эрмитаж, а их место заняли копии.
        '''
    , '/static/audio-room1.mp3', '/static/room5.png'),
    (6, 'Зелёная гостиная', 
        '''
            Князья Юсуповы славились европейским уровнем культуры и неограниченным
            финансовыми возможностями, позволявшими не только следовать последней моде,
            ...
            в Эрмитаж, а их место заняли копии.
        '''
    , '/static/audio-room1.mp3', '/static/room6.png'),
    (7, 'Танцевальный зал', 
        '''
            Князья Юсуповы славились европейским уровнем культуры и неограниченным
            финансовыми возможностями, позволявшими не только следовать последней моде,
            ...
            в Эрмитаж, а их место заняли копии.
        '''
    , '/static/audio-room1.mp3', '/static/room7.png'),
]
